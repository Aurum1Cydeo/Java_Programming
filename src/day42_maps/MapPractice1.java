...
public class MapPractice1 {
    public static void main(String[] args) {
        ...
        System.out.println("----------how many female and male employees in the map------------");
       ...
       /* for(String name : employeeMap.keySet()){
        ...
        System.out.println("---------------Display the names of all female employees------------------------");
        ...
        System.out.println("------------Update all the value M to Male and F to Female--------------");
