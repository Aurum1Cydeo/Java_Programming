...
public class DigitLetterSpecialChar {
    public static void main(String[] args) {
        ...
        String str = new Scanner(System.in).nextLine();//if there is only one input,we can put
        // everything in one line without closing the scan
        ...
        if(str.length()>=1){//if the string has at least one character
            ...
            if(f >= 48 && f <= 57){//they are the same f >='0' && f <= '9'
