...
if (salary>= 45000 && creditScore >= 700){
         result = "You are eligible for the loan" ;  //System.out.println("You are eligible for the loan");
}else {
       result = "You are not eligible for the loan";         //System.out.println("You are not eligible");
}
