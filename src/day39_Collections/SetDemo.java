...
public class SetDemo {
    public static void main(String[] args) {
        ...
        Set<Integer> set2 = new LinkedHashSet<>();//keeps insertion order ,accepts null keay
        ...
        Set<Integer> set3 = new TreeSet<>();//keeps inserting order ,does not accept duplicates
