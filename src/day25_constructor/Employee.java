...
public class Employee {
    ...
    public  String name;//"static" gives all employees the same name,instance lets to have different names
    public int age;
    public char gender;
    ...
    }//allows to set all the instance variables of the objects as soon as the objects is created
