...
public abstract class Employee {
    ...
    public Employee(String name, int age, char gender, String id, String jobTitle, double salary) {
        ...
        if (!(gender == 'M' || gender == 'F')) {
            throw new NoSuchPersonException("No such gender " + gender);
        }
        this.gender = gender;
        if (id == null || id.isEmpty()) {
            throw new IllegalArgumentException("ID of employee can not be null or empty");
        }
        this.id = id;
    ...
    public void setJobTitle(String jobTitle) {
        if (jobTitle == null || jobTitle.isEmpty()) {
            throw new NoSuchJobException("Job title can not be empty or null ");
        }
