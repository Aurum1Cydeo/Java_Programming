...
public class BulkOperations {
    public static void main(String[] args) {
        ...
        scores.addAll(Arrays.asList(75,85,70,80,90));
        System.out.println(scores);
        System.out.println("------------------------------------");
        ArrayList<String> students=new ArrayList<>();
        students.addAll(Arrays.asList("Gadir","Hasan","Bilal","Yasin"));
        System.out.println(students);
        students.addAll(2,Arrays.asList("Shukur","Julia","Tatiana"));
        System.out.println(students);
       ...
       // l1.addAll(Arrays.asList(nums));
        ...
        boolean hasMuhtarAliKuzzat=employeesList.containsAll(Arrays.asList("Muhtar","Ali","Kuzat"));
       ...
       list.removeAll(Arrays.asList(10,20));
        ...
        developers.addAll(Arrays.asList("Gadir","Hasan","Bilal","Alena","Yasin","Dilara","Kashiyar","Muhtar","Muhtar","Alena"));
        developers.retainAll(Arrays.asList("Alena","Kashiyar","Muhtar"));
